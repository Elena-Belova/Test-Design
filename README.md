...
Тест-дизайн – этап процесса тестирования ПО, на котором проектируются и создаются наборы тестовых случаев, обеспечивающих оптимальное тестовое покрытие.
...
:large_blue_diamond: ***РЖД "Возврат электронных билетов"*** <br>
<details>
